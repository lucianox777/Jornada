...
3. `Documentos/Anexo_Modelo_Fisico_Jornada_v1.40.md` e `Solution/database/Jornada_Fase1_v3.71.sql` para o schema técnico candidato, regenerando os derivados DOCX/PDF antes de nova publicação de entrega;
