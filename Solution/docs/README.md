...
**Decisões recentes revisadas:** [Calibração FS, corpus e ciclo de vida IBGE (26/09/2026)](Decisoes_Linkage_Calibracao_IBGE_20260926.md). Esta síntese distingue o que já está implementado de critérios pendentes e prevalece sobre defaults/descritivos históricos contraditórios.\n\n**Leia primeiro:** [Estado atual](Estado_Atual_Projeto.md), [Diretrizes consolidadas](Diretrizes_Identidade_Progressiva_Apoio_Decisao.md), [Plano](Plano_Desenvolvimento.md), [Ensaio único e paridade HML](Ensaio_Unico_Paridade_HML.md), [Testes e operação](Testes_Operacao_Indice.md), [Índice do acervo](Indice_Acervo_Documental.md). **Fases:** DEV → Ensaio único → HML → Produção. Todos os contratos previstos para HML devem estar prontos antes do Ensaio; HML usa massa de testes preparada pelas Secretarias, preservando as características relevantes das bases reais. Para retomar o projeto, consulte o Estado atual e só então o documento do domínio e o código/Actions relevantes.

**Separação obrigatória antes do Ensaio:** criar Solução de Apoio às Secretarias com preparador de arquivos para ZIP Jornada, transmissor existente e contratos versionados sincronizados com a Jornada; migrar para ela os recursos específicos da SEHAB e retirar as dependências correspondentes da solução principal. Ver [Ensaio único — ferramentas de apoio](Ensaio_Unico_Paridade_HML.md#ferramentas-de-apoio-às-secretarias--requisito-de-entrada) e [Plano](Plano_Desenvolvimento.md). Trata-se de requisito planejado, ainda não entrega comprovada.
