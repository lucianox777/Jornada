...
def validate_current_schema() -> None:
    ...
    require(
        ...
        (
            ...
            "auditoria.sp_registrar_conferencia_linkage",
            "auditoria.sp_assert_conferencia_linkage_conforme",
    ...
    require(
        ...
        (
            ...
            "migrations/20260920_Linkage_Conference_Command_Governance.sql",
            "migrations/20260922_Linkage_Synthetic_Evaluation_Evidence.sql",
