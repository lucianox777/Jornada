...
SEED_CANONICAL_KEY="sha256/8d/cc/${SEED_CANONICAL_SHA}.zip"
...
# para provar que o inventário diferencia referências válidas de candidato de expurgo sem apagar nada.
