    ...
    WHERE v.versao=5
      AND (
        ...
        OR v.pessoa_schema_sha256<>CASE g.codigo
            WHEN N'SEHAB' THEN 0xCA606BD59BA75301741579445E95E9C7C7357D95293B327354E69340BC639844
            WHEN N'SMADS' THEN 0x16340D6415DDDFF96E1CE18B4A9AF13FAFB993DB3D00488B187A900B1ECC2595
            WHEN N'SMDET' THEN 0xA08F45708D552CBF8801F1689C5229D886EB8AD0A85EB814FB0BE8EC405918D3
            WHEN N'SMS' THEN 0xD79907FD11DB6D1D8C9CE0260D8786432449CD7BAF4FB3BB27BEC0FC54727511
          END
      ))
