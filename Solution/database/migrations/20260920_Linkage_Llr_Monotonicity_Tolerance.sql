...
/*
  Ajusta somente a tolerância numérica do gate de monotonicidade nominal V6.
  Os parâmetros são persistidos em DECIMAL e o trigger calcula LOG(m/u) em FLOAT;
  diferenças abaixo de 1e-8 em log-odds são ruído de representação, não inversão
  material da ordem EXACT >= HIGH >= MEDIUM >= LOW.
*/
