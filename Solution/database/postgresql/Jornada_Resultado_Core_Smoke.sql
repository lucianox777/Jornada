...
SELECT gestor_id,'HabitaSampa','HabitaSampa'
...
VALUES(
    '70000000-0000-4000-8000-000000000001'::uuid,
    'ENTREGA_SEHAB_HabitaSampa_v2_aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa.zip',
