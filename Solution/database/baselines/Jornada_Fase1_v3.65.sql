...
IF OBJECT_ID('ref.atributo_transversal','U') IS NULL CREATE TABLE ref.atributo_transversal(
 ...
 CONSTRAINT ck_atributo_transversal_chave CHECK((cardinalidade='SINGLE' AND chave_instancia_codigo='UNICA_V1') OR (cardinalidade='MULTI' AND chave_instancia_codigo IN('TELEFONE_BR_CANONICO_V2','EMAIL_CASEFOLD_V1'))));
GO
...
UPDATE ref.atributo_transversal SET cardinalidade='MULTI',chave_instancia_codigo='EMAIL_CASEFOLD_V1' WHERE atributo_codigo='EMAIL_CONTATO';
...
ALTER TABLE ref.atributo_transversal WITH CHECK ADD CONSTRAINT ck_atributo_transversal_chave CHECK((cardinalidade='SINGLE' AND chave_instancia_codigo='UNICA_V1') OR (cardinalidade='MULTI' AND chave_instancia_codigo IN('TELEFONE_BR_CANONICO_V2','EMAIL_CASEFOLD_V1')));
GO
...
SET atributo_instancia_chave=CASE atributo_codigo
 ...
 WHEN 'EMAIL_CONTATO' THEN LOWER(LTRIM(RTRIM(valor)))
 ELSE '#' END
...
UPDATE ga SET atributo_instancia_chave=COALESCE(pao.atributo_instancia_chave,CASE ga.atributo_codigo WHEN 'TELEFONE_CONTATO' THEN CASE WHEN LEN(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(LTRIM(RTRIM(ga.valor)),'+',''),' ',''),'-',''),'(',''),')',''),'.',''),'/', ''),CHAR(9),''),CHAR(160),'')) IN(10,11) THEN '55'+REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(LTRIM(RTRIM(ga.valor)),'+',''),' ',''),'-',''),'(',''),')',''),'.',''),'/', ''),CHAR(9),''),CHAR(160),'') ELSE REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(LTRIM(RTRIM(ga.valor)),'+',''),' ',''),'-',''),'(',''),')',''),'.',''),'/', ''),CHAR(9),''),CHAR(160),'') END WHEN 'EMAIL_CONTATO' THEN LOWER(LTRIM(RTRIM(ga.valor))) ELSE '#' END)
...
-- Se representações legadas distintas convergirem, conserva a evidência de maior precedência e encerra apenas duplicatas lógicas correntes.
;WITH d AS(
 ...
 FROM gold.pessoa_atributo WHERE vigencia_fim IS NULL AND atributo_codigo='TELEFONE_CONTATO')
