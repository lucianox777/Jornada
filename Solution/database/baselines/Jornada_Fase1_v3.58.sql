...
IF OBJECT_ID('ref.atributo_transversal','U') IS NULL CREATE TABLE ref.atributo_transversal(
 ...
 CONSTRAINT ck_atributo_transversal_chave CHECK((cardinalidade='SINGLE' AND chave_instancia_codigo='UNICA_V1') OR (cardinalidade='MULTI' AND chave_instancia_codigo IN('TELEFONE_DIGITOS_V1','EMAIL_CASEFOLD_V1'))));
GO
...
UPDATE ref.atributo_transversal SET cardinalidade='MULTI',chave_instancia_codigo='TELEFONE_DIGITOS_V1' WHERE atributo_codigo='TELEFONE_CONTATO';
...
ALTER TABLE ref.atributo_transversal WITH CHECK ADD CONSTRAINT ck_atributo_transversal_chave CHECK((cardinalidade='SINGLE' AND chave_instancia_codigo='UNICA_V1') OR (cardinalidade='MULTI' AND chave_instancia_codigo IN('TELEFONE_DIGITOS_V1','EMAIL_CASEFOLD_V1')));
GO
...
SET atributo_instancia_chave=CASE atributo_codigo
 WHEN 'TELEFONE_CONTATO' THEN REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(LTRIM(RTRIM(valor)),'+',''),' ',''),'-',''),'(',''),')',''),'.',''),'/',''),CHAR(9),''),CHAR(160),'')
...
UPDATE ga SET atributo_instancia_chave=COALESCE(pao.atributo_instancia_chave,CASE ga.atributo_codigo WHEN 'TELEFONE_CONTATO' THEN REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(LTRIM(RTRIM(ga.valor)),'+',''),' ',''),'-',''),'(',''),')',''),'.',''),'/', ''),CHAR(9),''),CHAR(160),'') WHEN 'EMAIL_CONTATO' THEN LOWER(LTRIM(RTRIM(ga.valor))) ELSE '#' END)
