...
public sealed class OpenApiRuntimeConformanceTests : IDisposable
{
    ...
    [
        ...
        new(HttpMethod.Post, "/api/v1/identidade/correcoes", "/api/v1/identidade/correcoes", "post", Json("{\"cpf\":\"52998224725\",\"grupoTitularCpf\":\"A\",\"grupos\":[],\"atoReferencia\":\"TESTE\",\"justificativa\":\"TESTE\",\"evidencia\":{\"tipo\":\"DOCUMENTO_VERIFICADO\",\"documentoTipoCodigo\":\"RG\"}}")),
        new(HttpMethod.Post, "/api/v1/identidade/casos", "/api/v1/identidade/casos", "post", Json("{\"motivo\":\"TESTE\",\"pessoaObservacaoIds\":[1],\"atoReferencia\":\"TESTE\",\"justificativa\":\"TESTE\",\"evidencia\":{\"tipo\":\"CONFIRMACAO_INSTITUCIONAL_SEM_DOCUMENTO\"}}")),
        ...
        new(HttpMethod.Post, "/api/v1/divergencias/1/desfecho", "/api/v1/divergencias/{divergenciaId}/desfecho", "post", Json("{\"status\":\"RESOLVIDA\",\"desfecho\":\"TESTE\",\"evidencia\":{\"tipo\":\"CONFIRMACAO_INSTITUCIONAL_SEM_DOCUMENTO\"}}")),
