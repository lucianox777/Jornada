...
public sealed class OpenApiRuntimeConformanceTests : IDisposable
{
    ...
    [
        ...
        new(HttpMethod.Post, "/api/v1/identidade/casos/11111111-1111-1111-1111-111111111111/aplicar", "/api/v1/identidade/casos/{casoId}/aplicar", "post", Json("{\"grupos\":[],\"evidencia\":{\"tipo\":\"CONFIRMACAO_INSTITUCIONAL_SEM_DOCUMENTO\"}}")),
