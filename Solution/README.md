...
- `GET /health/ready` exige `Jornada.BaseNormativa=3.62` e `Jornada.SolutionSchema=3.71` e falha fechado quando os objetos essenciais não estão presentes.
- O instalador canônico editável é `database/Jornada_Fase1_v3.71.sql`.
...
- O inventário automatizado do schema consolidado contém **70 tabelas**, das quais 16 ficam fora do baseline legado de 53.
